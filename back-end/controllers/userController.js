...
const loginDataValidator = require("../validators/loginDataValidator");
...
app.post("/login", async (req, res) => {
  ...
  try {
    if (loginDataValidator.isValidEmail(email)) {
...
app.post("/", async (req, res) => {
  try {
    if (loginDataValidator.isValidEmail(req.body.email)) {
